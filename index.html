        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                ...
                <div class="nav-item dropdown">
                    ...
                    <a href="agendamento.html" class="nav-item nav-link">Agente a sua visita</a>
                    </div>  
                </div>
            </div>
        </nav>
    ...
    <div class="container-fluid bg-light pt-5">
        <div class="container py-5">
            <div class="d-flex flex-column text-center mb-5">
                ...
                <h1 class="display-4 m-0"><span class="text-primary">Serviços</span> Basicos</h1>
            </div>
            <div class="row pb-3">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        <h3 class=""><img src="img/vacina.png" alt=""></h3>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        <h3 class=""><img src="img/banho.jpg" alt=""></h3>
                        <h3 class="mb-3">Banho e tosa</h3>
                        <p>Banho e bom, mais com desconto e amor é melhor ainda</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        <h3 class=""><img src="img/lojinha.png" alt=""></h3>
                        <h3 class="mb-3">Lojinhas</h3>
                        <p>Temos uma grande variedades na nossa lojinha, desde alimentação até a proteção dos nossos pets.</p>
                    </div>
                </div>
            </div>
        </div>
